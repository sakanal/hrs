                        ...
                        <el-form-item label="房屋户型">
                          ...
                          <el-col :span="6">
                            <el-form-item prop="roomNumber">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')" v-model="baseForm.roomNumber"
                                        class="my-center-input">
                          ...
                          <el-col :span="6">
                            <el-form-item prop="hallNumber">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')" v-model="baseForm.hallNumber"
                                        class="my-center-input">
                                <template slot="prefix">&nbsp;共</template>
                          ...
                          <el-col :span="6">
                            <el-form-item prop="cloakroomNumber">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')"
                                        v-model="baseForm.cloakroomNumber" class="my-center-input">
                                <template slot="prefix">&nbsp;共</template>
                        ...
                        <el-form-item label="楼层信息">
                          ...
                          <el-col :span="6">
                            <el-form-item prop="floor">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')" v-model="baseForm.floor"
                                        class="my-center-input">
                          ...
                          <el-col :span="6">
                            <el-form-item prop="totalFloor">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')" v-model="baseForm.totalFloor"
                                        class="my-center-input">
                                <template slot="prefix">&nbsp;共</template>
                                <template slot="suffix">层&nbsp;</template>
                              </el-input>
                        ...
                        <el-form-item label="付款方式">
                          ...
                          <el-col :span="4">
                            <el-form-item prop="payNumber">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')" v-model="rentForm.payNumber"
                                        class="my-center-input">
                          ...
                          <el-col :span="4">
                            <el-form-item prop="mortgageNumber">
                              <el-input onkeyup="this.value=this.value.replace(/\D/g,'')"
                                        v-model="rentForm.mortgageNumber" class="my-center-input">
                          ...
                          <el-col :span="18">
                            <el-row>
                              <div style=" font-size: 14px; color: #999;line-height: 24px;">
                                请上传清晰、实拍的室内图片，请不要在图片上添加文字、数字、网址等内容，请勿上传名片、二维码、自拍照、风景照等与房源无关的图片，最多上传12张，每张最大2M。<br>
                                <span style="color: red">注意：首张图片将作为图片集的默认图片，在房源筛选时会显示该图片！</span>
                              </div>
                            </el-row>
                            <el-row style="margin-top: 25px">
                              <multi-upload fileDir="house/" v-model="imageForm"
                                            @multiUpload="multiUpload"></multi-upload>
                            </el-row>
                          </el-col>
                        </el-form-item>
                      </div>
    ...
    if (cookie.get('userToken')) {
      this.$axios.get('/user/login/userInfoByToken').then(response => {
        if (response && response.code === 0) {
          ...
          this.contactForm.publisherName = response.userInfo.nickName
          this.$axios.get(`/user/userbaseinfo/getPhone/${this.userInfo.id}`).then(response => {
            if (response && response.code === 0) {
