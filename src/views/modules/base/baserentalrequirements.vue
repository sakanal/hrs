    ...
    <el-card class="box-card">
      ...
      <div>
        <template  v-for="rentalRequirement in dataList">
          <el-tag :key="rentalRequirement.id" closable @close="handleCloseTag(rentalRequirement)" v-if="rentalRequirement.showState===1">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleCloseTag (rentalRequirement) {
        console.log(rentalRequirement)
      }
    }
  }
</script>
